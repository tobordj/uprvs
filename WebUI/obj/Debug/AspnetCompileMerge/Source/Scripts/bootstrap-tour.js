  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype._showPopover = function(step, i) {
        ...
        if (step.end) {
            content += "<a href='#' class='end'><i class='icon-remove'></i></a>";
        } else {
            content += "<a href='#" + step.next + "' class='next'> <i class='icon-forward'></i></a>          <a href='#' class='pull-right end'><i class='icon-remove'></i></a></p>";
        }
